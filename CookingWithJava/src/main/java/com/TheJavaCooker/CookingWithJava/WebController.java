...
public class WebController {
    ...
    public String formularioBuscarReceta(Model model, @RequestParam String nombreDeLaReceta, @RequestParam String tipoDePlato, @RequestParam String nivelDificultadReceta) {        //todo cambiar a POST
        ...
        recetasBuscadas = database.getRecetaRepository().buscarReceta(nombreDeLaReceta, tipoDePlato, nivel_de_dificultad);
